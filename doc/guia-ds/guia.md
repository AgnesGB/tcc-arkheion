...
## E. Atualização da Aplicação no Pythonanywhere

- Inicialmente, o repositório local DEVE ser sincronizado com as possíveis novidades do repositório remoto (*origin*);
~~~shell
$ git fetch origin
~~~
- Deve ser utilizada a senha local '4rkh310n!4dm1n'

## F. Acesso à Aplicação de Administração no Pythonanywhere

- Utilizar o endereço http://arkheion.pythonanywhere.com
- Utilizar as credenciais 'admin' e senha '4rkh310n'